...
description: Refactor bloated AGENTS.md, CLAUDE.md, or similar agent instruction fil–s to follow progressive disclosure principles. Splits monolithic files into organized, linked documentation.
license: MIT
---
