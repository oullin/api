...
func TestRecommendationsHandler(t *testing.T) {
	filehandler.RunFileHandlerTest(t, filehandler.FileHandlerTestCase{
		Make:     func(f string) filehandler.FileHandler { return NewRecommendationsHandler(f) },
		Endpoint: "/recommendations",
		Fixture:  "../../storage/fixture/recommendations.json",
		Assert:   filehandler.AssertFirstUUID("be1f8226-61d8-4b9b-a30f-0cdb521bd841"),
	})
}
...
func TestRecommendationsHandlerFiltersAndSortsFeaturedItems(t *testing.T) {
	...
	h := NewRecommendationsHandlerWithCache(path, false)
