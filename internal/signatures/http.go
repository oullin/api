...
func (s *SignaturesHandler) Generate(w http.ResponseWriter, r *http.Request) *endpoint.ApiError {
	...
	response := SignatureResponse{
		...
		Cadence: SignatureCadenceResponse{
...
func (s *SignaturesHandler) CreateSignature(request SignatureRequest, serverTime time.Time) (*database.APIKeySignatures, error) {
	var err error
