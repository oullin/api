...
func TestProjectsHandler_SortsAndPaginates(t *testing.T) {
	fixture := writeProjectsFixture(t, payload.ProjectsResponse{
		...
		Data: []payload.ProjectsData{
			{UUID: "project-1", Sort: 10, Title: "One", URL: "https://github.com/example/one", PublishedAt: "2026-03-01T00:00:00Z"},
			{UUID: "project-2", Sort: 1, Title: "Two", URL: "https://github.com/example/two", PublishedAt: "2026-03-10T00:00:00Z"},
			{UUID: "project-3", Sort: 9, Title: "Three", URL: "https://github.com/example/three", PublishedAt: "2026-03-03T00:00:00Z"},
			{UUID: "project-4", Sort: 3, Title: "Four", URL: "https://github.com/example/four", PublishedAt: "2026-03-08T00:00:00Z"},
			{UUID: "project-5", Sort: 8, Title: "Five", URL: "https://github.com/example/five", PublishedAt: "2026-03-02T00:00:00Z"},
			{UUID: "project-6", Sort: 4, Title: "Six", URL: "https://github.com/example/six", PublishedAt: "2026-03-07T00:00:00Z"},
			{UUID: "project-7", Sort: 5, Title: "Seven", URL: "https://github.com/example/seven", PublishedAt: "2026-03-06T00:00:00Z"},
			{UUID: "project-8", Sort: 2, Title: "Eight", URL: "https://github.com/example/eight", PublishedAt: "2026-03-09T00:00:00Z"},
			{UUID: "project-9", Sort: 6, Title: "Nine", URL: "https://github.com/example/nine", PublishedAt: "2026-03-05T00:00:00Z"},
			{UUID: "project-10", Sort: 7, Title: "Ten", URL: "https://github.com/example/ten", PublishedAt: "2026-03-04T00:00:00Z"},
		},
	})
	...
	if resp.Data[0].UUID != "project-2" || resp.Data[0].Sort != 1 {
...
func TestProjectsHandler_Page2(t *testing.T) {
	fixture := writeProjectsFixture(t, payload.ProjectsResponse{
		Version: "1.0.0",
		Data: []payload.ProjectsData{
			{UUID: "project-1", Sort: 9, Title: "One", URL: "https://github.com/example/one", PublishedAt: "2026-03-09T00:00:00Z"},
			{UUID: "project-2", Sort: 8, Title: "Two", URL: "https://github.com/example/two", PublishedAt: "2026-03-08T00:00:00Z"},
			{UUID: "project-3", Sort: 7, Title: "Three", URL: "https://github.com/example/three", PublishedAt: "2026-03-07T00:00:00Z"},
			{UUID: "project-4", Sort: 6, Title: "Four", URL: "https://github.com/example/four", PublishedAt: "2026-03-06T00:00:00Z"},
			{UUID: "project-5", Sort: 5, Title: "Five", URL: "https://github.com/example/five", PublishedAt: "2026-03-05T00:00:00Z"},
			{UUID: "project-6", Sort: 4, Title: "Six", URL: "https://github.com/example/six", PublishedAt: "2026-03-04T00:00:00Z"},
			{UUID: "project-7", Sort: 3, Title: "Seven", URL: "https://github.com/example/seven", PublishedAt: "2026-03-03T00:00:00Z"},
			{UUID: "project-8", Sort: 2, Title: "Eight", URL: "https://github.com/example/eight", PublishedAt: "2026-03-02T00:00:00Z"},
			{UUID: "project-9", Sort: 1, Title: "Nine", URL: "https://github.com/example/nine", PublishedAt: "2026-03-01T00:00:00Z"},
		},
	})
...
func TestProjectsHandler_NoStoreWhenCacheDisabled(t *testing.T) {
	fixture := writeProjectsFixture(t, payload.ProjectsResponse{
		Version: "1.0.0",
		Data: []payload.ProjectsData{
			{UUID: "project-1", Sort: 1, Title: "One", URL: "https://github.com/example/one", PublishedAt: "2026-03-01T00:00:00Z"},
		},
	})
...
func TestProjectsFixture_ContainsPublishedAtAndSortOnly(t *testing.T) {
	...
	for _, item := range raw.Data {
		if _, ok := item["published_at"]; !ok {
			t.Fatalf("expected published_at in fixture item: %+v", item)
		}

		if _, ok := item["sort"]; !ok {
			t.Fatalf("expected sort in fixture item: %+v", item)
		}
