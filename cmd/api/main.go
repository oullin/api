...
import (
	...
	kernel "github.com/oullin/internal/app/bootstrap"
	"github.com/oullin/internal/app/httpserver"
...
func run() error {
	...
	handler := httpserver.NewServerHandler(httpserver.ServerHandlerConfig{
		Mux:          app.GetMux(),
	...
	if err := httpserver.RunServer(addr, server); err != nil {
